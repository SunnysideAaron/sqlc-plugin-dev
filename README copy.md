...
if you want different files alltogether then fork sqlc-gen-from-template.
if you want a new plugin writen in a different language then???? what? How to do that?
